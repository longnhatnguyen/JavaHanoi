namespace E.Contract.API.Model.Contract
{
    public class ContractModel
    {
        ...
        public decimal amount_paid { get; set; } // số tiền đã thanh toán
        ...
        public int status { set; get; } // 0: hợp đồng nháp, 1 đã chọn số tiền , 2 đã xác minh otp , 3 đã chuyển tiền - chờ kế toán xác nhận, 4 
